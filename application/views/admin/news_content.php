<!DOCTYPE html>
<html lang="en"><!-- InstanceBegin template="/Templates/admin_news_events.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<!-- InstanceBeginEditable name="doctitle" -->
<title>News &amp; Events:: Listing</title>
<!-- InstanceEndEditable -->
<meta charset="utf-8">
        ...
        <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li><a href="index_edit.html"><i class="fa fa-home fa-fw"></i><span class="menu-title">Index Page</span></a> </li>
                    <li class="active"><a href="news_events_list.html"><i class="glyphicon glyphicon-camera fa-fw"></i><span class="menu-title">News &amp; Events</span></a> </li>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="panel panel-primary">
                        <div class="panel-heading pan"> <a href="news_events_details.html"><img src="../img/news_events/img_cny2014.jpg" class="img-responsive" alt="2014 Chinese New Year Celebration"/></a> </div>
                    ...
                    <div class="col-lg-4">
                      <div class="panel panel-primary">
                        <div class="panel-heading pan"> <a href="news_events_details.html"><img src="../img/news_events/img_xmas2013.jpg" class="img-responsive" alt="2013 Christmas Celebration"/></a> </div>
                        <div class="panel-footer text-center">
                          <input type="checkbox"/>
